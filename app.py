...
if st.session_state.page == 'input_view':
    ...
    st.markdown("<div class='info-text'>مرحباً بك في المنصة الأكاديمية المخصصة لمعالجة متجهات الحركة وديناميكا الأجرام بناءً على الحلول الرياضية والمعادلات الهيكلية لتوازن الأوساط.</div>", unsafe_allow_html=True)
    st.markdown("---")
    ...
    <div class="google-tos-container">
        ...
        <div class="google-tos-box">
            <b>قبل البدء باستخدام المنصة:</b> يُرجى قراءة بنود الخدمة التالية بعناية. باستخدامك لهذا النظام، فإنك توافق قانونياً وتقنياً على الالتزام الكامل بهذه الشروط والسياسات المعيارية المتبعة أكاديمياً:<br><br>
            
            <b>1. الطبيعة النظرية والافتراضية للحسابات:</b><br>
            يقر الطرف المستخدم ويدرك تمام العلم أن كافة النتائج، الأرقام، النسب المئوية، والاستنتاجات البنيوية المستخرجة من هذه المنصة هي عبارة عن حسابات ومعالجات رقمية مبنية بالكامل على معادلات رياضية افتراضية ونماذج تفسيرية ميكانيكية لتوازن الأوساط وثوابتها الحتمية. لا تعد هذه النتائج حقائق فلكية نهائية أو مطلقة إلا بعد التحقق الرصدي التجريبي المستقل وإقرارها رسمياً من الهيئات والجامعات الفلكية المعنية والمنشورات المحكمة.<br><br>
    ...
    if accepted_tos:
        ...
        st.info("ℹ️ يرجى قراءة بنود الخدمة وجداول الافتراضات المذكورة في صندوق جوجل أعلاه، ثم تفعيل مربع الموافقة لتتمكن من فتح حقول البيانات واستخدام المستشار.")
...
# ========================================================
    ...
    <div class="result-box">
        ...
        <p><b>🌌 نسبة مقاومة الوسط الكوني المكافئة ميكانيكياً للكتلة المفقودة:</b> <span style='color: #ffad33; font-size: 1.3rem; font-weight: bold;'>{dark_matter_ratio:.2f} %</span></p>
        <p><b>📐 الشكل الحركي المستنتج للبنية المجرّية:</b> <span style='color: #ffffff;'>{galaxy_shape}</span></p>
        <p><b>🔄 الميكانيكية الديناميكية المتبعة في الحركة والتوازن:</b> <span style='color: #ffffff;'>{galaxy_motion}</span></p>
        ...
        * تنويه قانوني: تم استخراج هذه التقارير والتحليلات آلياً بناءً على القوانين الرياضية والمعالجات الافتراضية لمنصة المستشار الفيزيائي لحماية الملكية والتوثيق الأكاديمي.
        </p>
    ...
    <div class="premium-box">
        ...
        الوصول الكامل إلى قيم ومصفوفات <b>(معامل التشوه الهيكلي للوسط)</b> والمخططات والرسوم البيانية المحاكية لـ <b>(معادلة يوسف للاتزان ومقاومة الوسط)</b> متاح الآن للباحثين والمختبرات عبر الاشتراك المباشر:
        </p>
